...
class gsp_principalesCreditos_reportesbitacoraPDP_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/reportes/bitacoraPDP.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('form','g',27,['action':("bitacoraPDP"),'class':("col-lg-12")],1)
printHtmlPart(4)
}
...
public static final long LAST_MODIFIED = 1566230521484L
