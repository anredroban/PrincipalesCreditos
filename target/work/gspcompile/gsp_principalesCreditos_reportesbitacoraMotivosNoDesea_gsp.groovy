...
class gsp_principalesCreditos_reportesbitacoraMotivosNoDesea_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/reportes/bitacoraMotivosNoDesea.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('form','g',27,['action':("bitacoraMotivosNoDesea"),'class':("col-lg-12")],1)
printHtmlPart(4)
}
...
public static final long LAST_MODIFIED = 1568419859751L
