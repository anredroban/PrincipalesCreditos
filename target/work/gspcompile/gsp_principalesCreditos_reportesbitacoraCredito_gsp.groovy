...
class gsp_principalesCreditos_reportesbitacoraCredito_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/reportes/bitacoraCredito.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('form','g',27,['action':("bitacoraCredito"),'class':("col-lg-12")],1)
printHtmlPart(4)
}
...
public static final long LAST_MODIFIED = 1566230265763L
