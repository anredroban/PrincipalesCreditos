...
class gsp_principalesCreditos_reportesbitacoraLatamNoClientes_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/reportes/bitacoraLatamNoClientes.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(1, {->
printHtmlPart(2)
invokeTag('submitButton','g',26,['class':("btn btn-warning"),'style':("height: 40px; width: 170px; font-weight: bold; font-family: 'Myriad Pro'; font-size: 16px"),'name':("btnEnviar"),'value':("Descargar Reporte")],-1)
printHtmlPart(3)
})
invokeTag('form','g',27,['action':("bitacoraLatamNoClientes"),'class':("col-lg-12")],1)
printHtmlPart(4)
}
...
public static final long LAST_MODIFIED = 1566230297264L
