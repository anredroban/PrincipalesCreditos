...
class gsp_principalesCreditos_reportesbitacoraNoClientes_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/reportes/bitacoraNoClientes.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(3)
invokeTag('submitButton','g',29,['class':("btn btn-info"),'name':("btnEnviar"),'value':("Enviar")],-1)
printHtmlPart(4)
})
invokeTag('form','g',31,['action':("bitacoraNoClientes"),'class':("col-lg-12")],1)
printHtmlPart(5)
}
...
public static final long LAST_MODIFIED = 1545427242308L
