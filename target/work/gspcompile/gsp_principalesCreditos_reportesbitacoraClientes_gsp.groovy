...
class gsp_principalesCreditos_reportesbitacoraClientes_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/reportes/bitacoraClientes.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('form','g',27,['action':("bitacoraClientes"),'class':("col-lg-12")],1)
printHtmlPart(4)
}
...
public static final long LAST_MODIFIED = 1578940866210L
