...
class gsp_principalesCreditos_reportesbaseGestionada_gsp extends GroovyPage {
...
createTagBody(1, {->
printHtmlPart(2)
invokeTag('select','g',27,['class':("form-control"),'name':("nombreBase"),'multiple':("true"),'size':("10"),'required':(""),'from':(utilitarios.Util.getNombresBase())],-1)
printHtmlPart(3)
...
public static final long LAST_MODIFIED = 1557781564718L
