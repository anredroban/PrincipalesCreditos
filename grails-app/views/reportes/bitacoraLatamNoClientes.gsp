...
<div class="container-fluid">
    <g:form action = "bitacoraLatamNoClientes" class="col-lg-12">
        <ol class="breadcrumb">
            <li class="active">
                <i class="fa fa-bitcoin"></i>  Trama No Clientes de Campaña Latam Banco Pichincha
            </li>
        </ol>
       ...
       <%-- <div class="form-group col-lg-6">
        ...
        <div class="form-group col-lg-12">
            <g:submitButton class="btn btn-warning" style="height: 40px; width: 170px; font-weight: bold; font-family: 'Myriad Pro'; font-size: 16px" name = "btnEnviar" value = "Descargar Reporte"></g:submitButton>
        </div>
    </g:form>
</div>