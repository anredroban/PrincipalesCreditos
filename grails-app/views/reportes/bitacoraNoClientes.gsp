...
<div class="container-fluid">
    <g:form action = "bitacoraNoClientes" class="col-lg-12">
        <ol class="breadcrumb">
            <li class="active">
                <i class="fa fa-android"></i>  Trama No Clientes Banco Pichincha
            </li>
        </ol>
        ...
        <div class="col-lg-12">
            <g:submitButton class="btn btn-info" name = "btnEnviar" value = "Enviar"></g:submitButton>
        </div>
    </g:form>
</div>