...
<div class="container-fluid">
    <g:form action = "bitacoraPrincipales" class="col-lg-12">
        <ol class="breadcrumb">
            <li class="active">
                <i class="fa fa-table"></i>  Trama Clientes Banco Pichincha
            </li>
        </ol>
        ...
        <div class="col-lg-12">
            <g:submitButton class="btn btn-primary" name = "btnEnviar" value = "Enviar"></g:submitButton>
        </div>
    </g:form>
</div>