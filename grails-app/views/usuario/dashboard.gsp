...
<head>
    ...
    <title>Principales Credito - Dashboard</title>
                    ...
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-xs-9 text-right">
                                <div class="huge">${Util.getCantidadAsistencias()}</div>
                                <div>¡Ventas PDP diarias!</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="panel panel-personalizado">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-xs-9 text-right">
                                <div class="huge">${Util.getCantidadAsistenciasMes()}</div>
                                <div>¡Ventas PDP en el mes!</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="panel panel-yellow">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-xs-9 text-right">
                                <div class="huge">${Util.getCantidadCredito()}</div>
                                <div>¡Exitosos Crédito CU1!</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="panel panel-brown">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-xs-9 text-right">
                                <div class="huge">${Util.getCantidadCu2()}</div>

                                <div>¡Ventas Cruzadas CU3!</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="panel panel-dark-gray">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-xs-9 text-right">
                                <div class="huge">${Util.getMontosCredito()}</div>
                                <div>¡Monto Consolidado Créditos!</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="panel panel-dark-gray">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-xs-9 text-right">
                                <div class="huge">${Util.getCantidadVentasMensual()}</div>
                                <div>¡Exitosas TDC en el mes!</div>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div style="min-width: 310px; height: 400px; margin: 0 auto">
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tr style="color: blue; background-color: #D3D3D3;">
                                    <td><strong>TOTAL</strong></td><td><strong>${totalGestionados}</strong></td><td><strong>${totalContactados}</strong></td><td><strong>${totalNoContactados}</strong></td><td><strong>${totalExitosos}</strong></td><td><strong>${totalCreditos}</strong></td><td><strong>${totalCruzadas}</strong></td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
                    ...
                    <div class="table-responsive">
                        <div style="min-width: 310px; height: 400px; max-width: 600px; margin: 0 auto">
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
                                <g:each in="${ventasPorHoraVendedor}">
                                    <tr>

                                        <td>${it[0]}:00</td><td>${it[1]}</td><td>${it[2]}</td>
                                    </tr>
                                </g:each>
                                </tbody>
                            </table>
