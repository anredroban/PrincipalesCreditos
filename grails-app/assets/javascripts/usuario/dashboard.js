...
//	Grafico pie con leyenda CU1
    ...
    $.get(baseUrl + "/funcionesAjax/grafSubSubCu2", function(data){
        ...
        if(Object.keys(data).length > 0){
            ...
            $('#containerpieCu2').html("<div class='col-lg-12' style='text-align: center; color: red; margin-top: 100px'><h5>SubEstatus Inactivo !CU2!</h5></div>");
        }
    });
    ...
    $.get(baseUrl + "/funcionesAjax/getGrafLineas"
        ...
        , function(data){
            ...
            $('#containerlinereport').highcharts({
                ...
                subtitle: {
                    text: 'TDC y Crédito Banco Pichincha'
                },
                xAxis: {
                    categories: categorias
                },
